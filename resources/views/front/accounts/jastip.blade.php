...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold m-0">Jastip Akun</h3>
    </div>
    
    <form action="{{ route('accounts.jastip') }}" method="GET" id="searchForm" class="mb-5">
        <div class="d-flex gap-2">
            ...
            @if(request()->hasAny(['search', 'category', 'status']))
                <a href="{{ route('accounts.jastip') }}" class="btn btn-outline-danger rounded-circle shadow-sm d-flex align-items-center justify-content-center flex-shrink-0" style="width: 45px; height: 45px;" title="Reset Filter"><i class="fas fa-times"></i></a>
            @endif
        </div>
